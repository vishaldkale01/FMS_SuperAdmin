...
import City from '../pages/FMS/Super_Admin/City';
import Country from '../pages/FMS/Super_Admin/Country';
import State from '../pages/FMS/Super_Admin/State';
import Border from '../pages/FMS/Super_Admin/Border';
import Route from '../pages/FMS/Super_Admin/Route';
...
import Payment from '../pages/FMS/Super_Admin/Payment';
import AdminsubcriptionList from '../pages/FMS/Super_Admin/AdminsubcriptionList';
import Subscription from '../pages/FMS/Super_Admin/Subscription';
...
const routes = [
    ...
    {
        path: '/location/AdminsubcriptionList',
        element: <AdminsubcriptionList />,
    },
    {
        path: '/location/Subscription',
