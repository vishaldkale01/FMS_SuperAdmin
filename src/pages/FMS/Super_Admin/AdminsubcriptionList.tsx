                                ...
                                {filteredItems.map((userData: any , i : any) => {
                                    return (
                                        <tr key={userData.id}>
                                            ...
                                            <td className="whitespace-nowrap">{userData.startDate.slice(0, 10)}</td>
                                            <td className="whitespace-nowrap">{userData.endDate.slice(0, 10)}</td>
...
export default AdminsubcriptionList;
