...
{/* 
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'location' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/location/country">{t('Add admin')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/location/city" >
                                                {t('Assign Subscription plan')}
                                            </NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink to="/location/route">{t('Add Payment')}</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink to="/location/Subscription" >
                                                {t('Subscription plan List')}
                                            </NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/location/AdminsubcriptionList" >
                                                {t('admin subscription List')}
                                            </NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/location/Payment">
                                                {t('Payament List')}
                                            </NavLink>
                                        </li>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'location' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            ...
                                            <li>
                                            <NavLink to="/location/country">{t(' admin list')}</NavLink>
                                            </li>
                                            </ul>
                                </AnimateHeight>
